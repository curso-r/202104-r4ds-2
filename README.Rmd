...
knitr::kable(
  tibble::tibble(
    script = CursoRutils:::list_github_files(main_repo, pasta, "R"),
    link = paste0("https://curso-r.github.io/", turma, "/", script)
  ) %>% 
    dplyr::slice(1)
)
```
...
knitr::kable(
  tibble::tibble(
    script = CursoRutils:::list_github_files(main_repo, pasta, "R|Rmd"),
    link = paste0("https://curso-r.github.io/", turma, "/", script)
  ) %>% 
    dplyr::slice(1)
)
